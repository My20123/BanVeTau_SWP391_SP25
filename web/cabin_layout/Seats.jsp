    ...
    <div class="row et-car-floor"> 
        ...
        <div class="et-car-nm-64-half-block">
            ...
            if (seat.getStatus() == 1) {
                ...
                <div class="et-car-nm-64-sit ng-isolate-scope" data-seat-number="<%= i%>" data-seat-price="<%=seatPrice%>" data-seat-status="<%=seat.getStatus()%>">
                ...
                <% for (int j = seatsInRow / 2 + 1; j <= seatsInRow; j++) {
                        for (int i = 1; i <= totalSeats / 2; i++) {
                            if (i % seatsInRow == j) {int seatPrice = dao.updateSeatsPrice(depart, desti, sid, ctype, cbid, i);
                Seats seat=dao.get1SeatWithCabinIdNSeatN0(cbid, i);
                String seatClass = "";
            if (seat.getStatus() == 1) {
                seatClass = "et-sit-buying"; // select ghế
               ...
               <div class="et-car-nm-64-sit ng-isolate-scope" data-seat-number="<%= i%>" data-seat-price="<%=seatPrice%>" data-seat-status="<%=seat.getStatus()%>">
                ...
                <% }
                    ...
                    for (int i = 1; i <= totalSeats / 2; i++) {
                        if (i % seatsInRow == 0) {int seatPrice = dao.updateSeatsPrice(depart, desti, sid, ctype, cbid, i);
                Seats seat=dao.get1SeatWithCabinIdNSeatN0(cbid, i);
                String seatClass = "";
            if (seat.getStatus() == 1) {
                seatClass = "et-sit-buying"; // select ghế
                ...
                <div class="et-car-nm-64-sit ng-isolate-scope" data-seat-number="<%=i%>" data-seat-price="<%=seatPrice%>" data-seat-status="<%=seat.getStatus()%>"> 
                   <div class="et-car-seat-right et-seat-h-35">
                        <div class="et-col-84 et-sit-sur-outer-invert">
                            <div class="et-sit-sur-invert text-center <%=seatClass%>">
                                 <div class="et-sit-no ng-scope">
                                    <span><%= i%></span> 
                                    <img src="/images/loading51.gif"  class="ng-hide"></div>
                            </div>
